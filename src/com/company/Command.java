...
public class Command
{
    ...
    public final static String tabCommand[] = {"Help","Exit","Create","Delete","Info_Cara","Number_Of_Cara","Fight", "CreateWarrior","CreateWizard", "CreateThief", "CreateBasicArchetype"};
